...
export const themeStylePropsSchema = z.object({
  // Standard shadcn/TweakCN variables
  ...
  // JPortal custom variables
  "destructive2": z.string().describe("Additional destructive color variant."),
  "day-selected": z.string().describe("Selected day background color."),
  active: z.string().describe("Active state background color."),
  "active2": z.string().describe("Secondary active state background color."),

  // Extended accent colors (accent2-accent10)
  "accent2": z.string().describe("Second accent color."),
  "accent3": z.string().describe("Third accent color."),
  "accent4": z.string().describe("Fourth accent color."),
  "accent5": z.string().describe("Fifth accent color."),
  "accent6": z.string().describe("Sixth accent color."),
  "accent7": z.string().describe("Seventh accent color."),
  "accent8": z.string().describe("Eighth accent color."),
  "accent9": z.string().describe("Ninth accent color."),
  "accent10": z.string().describe("Tenth accent color."),

  // Ring variations
  "ring-hover": z.string().describe("Ring color on hover state."),

  // Calendar specific colors
  "calendar-positive": z.string().describe("Calendar positive indicator color."),
  "calendar-negative": z.string().describe("Calendar negative indicator color."),
  "calendar-positive2": z.string().describe("Secondary calendar positive color."),
  "calendar-negative2": z.string().describe("Secondary calendar negative color."),

  // Border variations
  "border-subtle": z.string().describe("Subtle border color."),

  // Grade colors
  "grade-aa": z.string().describe("AA grade color."),
  "grade-a": z.string().describe("A grade color."),
  "grade-bb": z.string().describe("BB grade color."),
  "grade-b": z.string().describe("B grade color."),
  "grade-cc": z.string().describe("CC grade color."),
  "grade-c": z.string().describe("C grade color."),
  "grade-d": z.string().describe("D grade color."),
  "grade-f": z.string().describe("F grade color."),

  // Marks colors
  "marks-outstanding": z.string().describe("Outstanding marks color."),
  "marks-good": z.string().describe("Good marks color."),
  "marks-average": z.string().describe("Average marks color."),
  "marks-poor": z.string().describe("Poor marks color."),
});
